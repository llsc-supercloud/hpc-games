...
2. **Start new jobs:** Draw a card and place it at the end of the Pending Queue. Select the corresponding job pieces for the drawn card and place them on the card. Then, starting at the beginning of the Pending Queue, start as many new Jobs as you can. To start a job, place the job pieces on the board, pick up the card from the pending queue, turn the card over and place at the end of the Running Queue. Each Job Type has rules about how/when/where it can run:
